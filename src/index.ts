...
export function main(): void {
  ...
  executeTask(async () => {
    const wearables = await crypto.wearable.getListOfWearables({
      collectionIds: ['urn:decentraland:matic:collections-v2:0x02048643e32f893406dc2012a2f48a3023645612']
    })
    ...
    wearables.forEach((wearable, index) => {
      ...
      // Texto con el nombre del wearable
      ...
      // Apply texture (thumbnail IPFS image)
