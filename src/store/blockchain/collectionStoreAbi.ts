export const collectionStoreAbi = [
  [
    {
      constant: true,
    ...
    },
    {
      anonymous: false,
      inputs: [
        { indexed: true, internalType: 'bytes32', name: '_wearableIdKey', type: 'bytes32' },
        { indexed: false, internalType: 'string', name: '_wearableId', type: 'string' },
        { indexed: false, internalType: 'uint256', name: '_maxIssuance', type: 'uint256' }
      ],
      name: 'AddWearable',
      type: 'event'
    },
    {
      ...
      inputs: [
        ...
        { indexed: true, internalType: 'bytes32', name: '_wearableIdKey', type: 'bytes32' },
        { indexed: false, internalType: 'string', name: '_wearableId', type: 'string' },
        { indexed: false, internalType: 'uint256', name: '_issuedId', type: 'uint256' }
      ],
      name: 'Issue',
      type: 'event'
    },
